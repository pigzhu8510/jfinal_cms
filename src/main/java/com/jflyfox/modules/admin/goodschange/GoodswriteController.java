 ...
 */
@ControllerBind(controllerKey = "/admin/goodswrite")
public class GoodswriteController extends BaseProjectController {

	private static final String path = "/pages/admin/goodswrite/goodswrite_";
